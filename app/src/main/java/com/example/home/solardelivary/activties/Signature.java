...
import com.example.home.solardelivary.Api.DigitalApi;
import com.example.home.solardelivary.Model.DigitalClient;
...
public class Signature extends AppCompatActivity {
    ...
    String address;
    Bitmap bitmap;
    String DIRECTORY = Environment.getExternalStorageDirectory().getPath() + "/DeliverySignature/";
    ...
    private void upload(String storedPath) {
        ...
        Call<UploadImageResult> resultCall = service.uploadImage(body,id,deviceId,trip);
